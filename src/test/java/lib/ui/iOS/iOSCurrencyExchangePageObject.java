...
public class iOSCurrencyExchangePageObject extends CurrencyExchangePageObject {
    static {
        ...
        CURRENCY_LIST_AMOUNT = "xpath://XCUIElementTypeStaticText";
        ...
        CONFIRM_EXCHANGE_TITLE = "xpath://XCUIElementTypeStaticText";
        ...
        CONFIRM_BUTTON = "xpath://XCUIElementTypeButton[@name='Confirm']";
        ...
        BACK_TO_HOME_BUTTON = "xpath://XCUIElementTypeButton[@name='Continue']";
        ...
        CURRENCY_LIST_AMOUNT = "xpath://XCUIElementTypeStaticText[@name='€35.50']";
